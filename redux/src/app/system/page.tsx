  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-white">
      <form onSubmit={handleSubmit} className="w-full max-w-md p-6 bg-gray-100 rounded-lg shadow-md">
        <h2 className="text-xl font-semibold text-gray-700 mb-4">Config Editor</h2>
          ...
          <div key={config.config_name} className="mb-4">
            <label className="block text-gray-600 mb-1">
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:ring-blue-500"
                required
              />
            </label>
          </div>
